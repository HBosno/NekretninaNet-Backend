...
public class QueryController {
    ...
    @PostMapping("/real-estate-query/{realEstateId}/{userId}")
    ...
    @GetMapping("/real-estate-queries/{username}")
public ResponseEntity<?> getQueriesForUser(@PathVariable String username) {
 ...
 @PatchMapping("/real-estate-queries/{id}")
    public ResponseEntity<?> updateQuery(@PathVariable Long id,
     ...
     @PostMapping("/support-request/{userId}")
